...
const AccountCard = ({wallet, index, handleWalletDelete}: {wallet: Wallet, index: number, handleWalletDelete: (index: number) => void}) => {
    ...
    return (
        <div className='w-full rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden bg-white dark:bg-zinc-900 shadow-sm hover:shadow-md transition-shadow duration-300 my-6'>
